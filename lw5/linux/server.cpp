...
void Bind(int sock, struct sockaddr_in * address)
{
...
void AppendNewClients(int clients[], int master_sock, fd_set * readfds, struct sockaddr_in * address)
{
...
int main(int argc , char *argv[])
{
    ...
    int master_socket = NewSocket(AF_INET);
    ...
    std::cout << "Waiting for connections on port 8888" << endl;
